...
Local flow definitions are tracked in `~/.config/openpai/PAI/FLOWS/flow-index.json`:
...
Flow state (run history, errors) is tracked in `~/.config/openpai/MEMORY/STATE/flow-state.json`.
...
- **Actions:** `~/.config/openpai/PAI/ACTIONS.md` *(planned)*
- **Pipelines:** `~/.config/openpai/PAI/PIPELINES.md`
- **Architecture:** `~/.config/openpai/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `~/.config/openpai/PAI/FLOWS/README.md`
