...
**Primary Skill:** `~/.config/openpai/skills/Fabric/SKILL.md`
...
**Patterns Location:** `~/.config/openpai/skills/Fabric/Patterns/` (237 patterns)
...
-> Runs fabric -U
-> Syncs to ~/.config/openpai/skills/Fabric/Patterns/
```

**Manual:**
```bash
fabric -U && rsync -av ~/.config/fabric/patterns/ ~/.config/openpai/skills/Fabric/Patterns/
```
...
- **Full Skill:** `~/.config/openpai/skills/Fabric/SKILL.md`
- **Pattern Execution:** `~/.config/openpai/skills/Fabric/Workflows/ExecutePattern.md`
- **Pattern Updates:** `~/.config/openpai/skills/Fabric/Workflows/UpdatePatterns.md`
- **All Patterns:** `~/.config/openpai/skills/Fabric/Patterns/`
