...
const OPENPAI_DIR = join(HOME, ".config/openpai");
...
function getStats(): SystemStats {
  ...
  try {
    const historyFile = join(OPENPAI_DIR, "history.jsonl");
...
function createNavyBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${C.royalBlue}\u21AA${RESET}  ${C.slate}Plugins${RESET}     ${C.periwinkle}${stats.plugins}${RESET}`,         // ↪ plugin arrow
...
function createElectricBanner(stats: SystemStats, width: number): string {
  ...
  const SYM = { user: "\u25c6", skills: "\u26a1", plugins: "\u2699", learn: "\u25c8", files: "\u25a0", model: "\u25ce", link: "\u21e2", pulse: "\u25cf", target: "\u25ce" };
  ...
  const infoLines = [
    ...
    `${P.neonBlue}${SYM.plugins}${RESET} ${P.glow}Plugins${RESET}      ${BOLD}${P.electricBlue}${stats.plugins}${RESET}`,
...
function createTealBanner(stats: SystemStats, width: number): string {
  ...
  const SYM = { user: "\u2756", skills: "\u25c6", plugins: "\u2699", learn: "\u25c7", files: "\u25a2", model: "\u25ce", link: "\u27a4", wave: "\u223c", drop: "\u25cf" };
  ...
  const infoLines = [
    ...
    `${P.mediumTeal}${SYM.plugins}${RESET} ${P.paleAqua}Plugins${RESET}      ${BOLD}${P.turquoise}${stats.plugins}${RESET}`,
...
function createIceBanner(stats: SystemStats, width: number): string {
  ...
  const SYM = { user: "\u2727", skills: "\u2726", plugins: "\u2699", learn: "\u25c7", files: "\u25a1", model: "\u25cb", link: "\u2192", snow: "\u2022", crystal: "\u2729" };
  ...
  const infoLines = [
    ...
    `${P.iceBlue}${SYM.plugins}${RESET} ${P.frost}Plugins${RESET}      ${BOLD}${P.pureWhite}${stats.plugins}${RESET}`,
...
function createNavyMediumBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${C.royalBlue}\u21AA${RESET}  ${C.slate}Plugins${RESET}     ${C.periwinkle}${stats.plugins}${RESET}`,
...
function createNavyCompactBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${C.lightBlue}\u2726${RESET} ${C.slate}SK${RESET} ${C.silver}${stats.skills}${RESET}  ${C.skyBlue}\u21BB${RESET} ${C.iceBlue}${stats.workflows}${RESET}  ${C.royalBlue}\u21AA${RESET} ${C.periwinkle}${stats.plugins}${RESET}`,
    `${C.medBlue}\u2726${RESET} ${C.slate}Signals${RESET} ${C.skyBlue}${stats.learnings}${RESET}`,
    `${C.steel}${BOX.h.repeat(18)}${RESET}`,
  ];
...
function createNavyMinimalBanner(stats: SystemStats, width: number): string {
  ...
  const infoLines = [
    ...
    `${C.lightBlue}\u2726${RESET}${C.silver}${stats.skills}${RESET} ${C.skyBlue}\u21BB${RESET}${C.iceBlue}${stats.workflows}${RESET} ${C.royalBlue}\u21AA${RESET}${C.periwinkle}${stats.plugins}${RESET}`,
    ``,
  ];
...
function createNavyUltraCompactBanner(stats: SystemStats, width: number): string {
  ...
  lines.push(center(`${C.lightBlue}\u2726${RESET}${C.silver}${stats.skills}${RESET} ${C.skyBlue}\u21BB${RESET}${C.iceBlue}${stats.workflows}${RESET} ${C.royalBlue}\u21AA${RESET}${C.periwinkle}${stats.plugins}${RESET}`, width));
  lines.push("");
