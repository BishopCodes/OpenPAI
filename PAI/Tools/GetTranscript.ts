 ...
 *
 * Usage:
 *   bun ~/.config/openpai/skills/Videotranscript/Tools/GetTranscript.ts <youtube-url>
 *   bun ~/.config/openpai/skills/Videotranscript/Tools/GetTranscript.ts <youtube-url> --save <output-file>
 *
 * Examples:
 *   bun ~/.config/openpai/skills/Videotranscript/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=abc123"
 *   bun ~/.config/openpai/skills/Videotranscript/Tools/GetTranscript.ts "https://youtu.be/abc123" --save transcript.txt
 *
 * @author PAI System
 * @version 1.0.0
 */
