...
function createRetroBanner(): string {
  ...
  const statsBox = [
    ...
    `${f}${BOX.sv}${RESET} ${g}Plugins${RESET}${gd}.......${RESET}: ${h}${String(stats.plugins).padEnd(8)}${RESET} ${f}${BOX.sv}${RESET}`,
  ...
  lines.push(`  ${g}>${RESET} ${h}github.com/openpai/OpenPAI${RESET}${BLINK}_${RESET}`);
  lines.push(`  ${gd}${BOX.sh.repeat(40)}${RESET}`);
...
function createPureASCIIBanner(): string {
  ...
  const statsBox = [
    ...
    "| Plugins......: " + String(stats.plugins).padEnd(10) + " |",
  ...
  lines.push("");
  lines.push(`  ${gd}----------------------------------------${RESET}`);
  lines.push(`  ${g}>${RESET} ${h}github.com/openpai/OpenPAI${RESET}${g}_${RESET}`);
  lines.push(`  ${gd}----------------------------------------${RESET}`);
...
function createCompactRetroBanner(): string {
  ...
  lines.push(`${gd}> github.com/openpai/OpenPAI${RESET}`);
