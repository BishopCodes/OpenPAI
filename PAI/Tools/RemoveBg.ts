 ...
 *
 * @see ~/.config/openpai/skills/Images/SKILL.md
 */
...
async function loadEnv(): Promise<void> {
  const envPath = process.env.PAI_CONFIG_DIR ? resolve(process.env.PAI_CONFIG_DIR, ".env") : resolve(process.env.HOME!, ".config/openpai/.env");
  try {
