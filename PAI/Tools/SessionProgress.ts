 ...
 * Based on Anthropic's opencode-progress.txt pattern.
 *
 * Usage:
 *   bun run ~/.config/openpai/PAI/Tools/SessionProgress.ts <command> [options]
 */
...
const PROGRESS_DIR = join(process.env.HOME || '', '.config/openpai', 'MEMORY', 'STATE', 'progress');
