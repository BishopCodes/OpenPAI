...
const BASE_DIR = process.env.PAI_DIR || join(process.env.HOME!, '.config/openpai');
...
const DOMAIN_MAP: DomainKeywords[] = [
  ...
  },
  {
    ...
    primary: [
      ...
      /\b(plugin|skill|tool|agent|algorithm)\b/i,
    ],
    secondary: [
  ...
  },
  {
    ...
    primary: [
      ...
      /\b(memory|state|plugin|skill|algorithm)\b/i,
