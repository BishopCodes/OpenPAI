...
**All documentation files are in `~/.config/openpai/PAI/` with USER/ subdirectory for personal overrides. Read these files when you need deeper context.**
...
**Agent System:**
- **Agents Skill** (`~/.config/openpai/skills/Agents/`) - Complete agent composition system | See Agents skill for custom agent creation, traits, and voice mappings
...
- `THEPLUGINSYSTEM.md` - Hook configuration | Triggers: "plugins configuration", "create custom plugins"
