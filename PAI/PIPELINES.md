...
Local pipeline definitions live in `~/.config/openpai/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md`
...
```bash
mkdir -p ~/.config/openpai/PAI/PIPELINES/[Domain]_[Pipeline-Name]
# PIPELINE-TEMPLATE.md is planned but not yet created
# For now, copy an existing pipeline and modify it
cp ~/.config/openpai/PAI/PIPELINES/Blog_Publish-Post/PIPELINE.md ~/.config/openpai/PAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md
```
...
- **Actions:** `~/.config/openpai/PAI/ACTIONS.md`
- **Flows:** `~/.config/openpai/PAI/FLOWS.md`
- **Architecture:** `~/.config/openpai/PAI/PAISYSTEMARCHITECTURE.md`
- **Detailed README:** `~/.config/openpai/PAI/PIPELINES/README.md`
