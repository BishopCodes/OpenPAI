...
Each action is a flat directory under `~/.config/openpai/PAI/ACTIONS/`:
...
mkdir ~/.config/openpai/PAI/USER/ACTIONS/A_YOUR_ACTION
```
...
- **Personal Actions:** `~/.config/openpai/PAI/USER/ACTIONS/`
