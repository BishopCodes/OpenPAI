...
```bash
mkdir -p ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/{test-cases,golden-outputs,prompts}
```

### Step 3: Create Config File

Create `~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/config.yaml`:
...
Create `~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/prompts/v1.0.0.md`:
...
Create test cases in `~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/test-cases/`:
...
Create `~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/README.md`:
...
\`\`\`bash
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name>
\`\`\`
...
```bash
# Check structure
ls -la ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/

# Validate config
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts use-case show <name>
```
...
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli-run.ts \
  --use-case <name> \
  --test-id 001-basic \
  --verbose
```
