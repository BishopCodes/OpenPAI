...
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts results \
  --use-case <name> \
  --latest
```
...
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts report \
  --run-id <run-id> \
  --output ~/.config/openpai/skills/Utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
bun run ~/.config/openpai/Templates/Tools/RenderTemplate.ts \
  -t Evals/Report.hbs \
  -d ~/.config/openpai/skills/Utilities/Evals/Results/<use-case>/<run-id>/results.yaml \
  -o ~/.config/openpai/skills/Utilities/Evals/Results/<use-case>/<run-id>/report.md
```
...
```bash
cd ~/.config/openpai/skills/Utilities/Evals/EvalServer
...
```bash
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts compare \
  --run-a <run-id-1> \
  --run-b <run-id-2>
```
...
```bash
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts trend \
  --use-case <name> \
  --days 30
```
