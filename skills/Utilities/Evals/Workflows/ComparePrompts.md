...
```bash
# Check prompts exist
ls ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/prompts/
...
Create `~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/comparisons/<comparison-name>.yaml`:
...
bun run ~/.config/openpai/Templates/Tools/RenderTemplate.ts \
  ...
  -d ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>.yaml \
  -o ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/comparisons/<name>-setup.md \
  --preview
```
