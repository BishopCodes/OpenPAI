...
```bash
# Create new use case
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts use-case create --name <name>

# List all use cases
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts use-case list
...
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts test-case add --use-case <name>

# List test cases for use case
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli.ts test-case list --use-case <name>
```
...
bun run ~/.config/openpai/skills/Utilities/Evals/EvalServer/cli-run.ts --use-case <name> [--model <model>]
```
...
```
~/.config/openpai/skills/Utilities/Evals/
├── UseCases/
│   └── <name>/
