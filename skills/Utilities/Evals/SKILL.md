...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Evals/`
...
```bash
# Run an eval suite
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s <suite>

# Log a failure for later conversion
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/FailureToTask.ts log "description" -c category -s severity

# Convert failures to test tasks
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/FailureToTask.ts convert-all

# Manage suites
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/SuiteManager.ts create <name> -t capability -d "description"
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/SuiteManager.ts list
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/SuiteManager.ts check-saturation <name>
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/SuiteManager.ts graduate <name>
```
...
bun run ~/.config/openpai/skills/Utilities/Evals/Tools/AlgorithmBridge.ts -s regression-core -r 3 -u
```
