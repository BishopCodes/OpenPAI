...
```
~/.config/openpai/Templates/Evals/
...
bun run ~/.config/openpai/Templates/Tools/RenderTemplate.ts \
  -t Evals/Judge.hbs \
  -d ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/judge-config.yaml \
  -o ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/judge-prompt.md
```
...
bun run ~/.config/openpai/Templates/Tools/RenderTemplate.ts \
  -t Evals/Rubric.hbs \
  -d ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/rubric.yaml \
  -o ~/.config/openpai/skills/Utilities/Evals/UseCases/<name>/rubric.md
```
