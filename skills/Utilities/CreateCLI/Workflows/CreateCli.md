...
**Reference:** `~/.config/openpai/PAI/CliFirstArchitecture.md` (Configuration Flags section)
...
For more information, see ~/.config/openpai/Bin/{{CLI_NAME}}/README.md
...
See: ~/.config/openpai/Bin/{{CLI_NAME}}/README.md
```
...
**Validation Commands:**
```bash
cd ~/.config/openpai/Bin/{{CLI_NAME}}/
chmod +x {{CLI_NAME}}.ts
./{{CLI_NAME}}.ts --help
./{{CLI_NAME}}.ts --version
```
...
**Report to user:**
```
✅ CLI Created: ~/.config/openpai/Bin/{{CLI_NAME}}/
...
Documentation: ~/.config/openpai/Bin/{{CLI_NAME}}/README.md
```
...
**Generated Output:**
```
✅ CLI Created: ~/.config/openpai/Bin/notioncli/
...
3. Read: ~/.config/openpai/Bin/notioncli/README.md
...
Use proven structure from ~/.config/openpai/Bin/llcli/ as reference.
