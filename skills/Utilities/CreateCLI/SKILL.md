...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/CreateCLI/`
...
- `~/.config/openpai/Bin/[cli-name]/` - Personal CLIs (like llcli)
...
- **mcp** - For web scraping CLIs (WebFetch, Playwright)
