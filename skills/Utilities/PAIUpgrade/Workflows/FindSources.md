...
```
Search: "OpenCode tutorial YouTube channel"
...
```
Search: site:github.com "OpenCode" examples
...
Edit `~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json`
...
cat ~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json
