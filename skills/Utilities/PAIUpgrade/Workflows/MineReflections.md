...
This workflow mines those reflections for **recurring themes** and produces **actionable upgrade candidates** for the Algorithm, skills, plugins, or system architecture.
...
UPGRADE CANDIDATE: [Theme Name]
  ...
  Proposed fix: [Specific change to Algorithm, skill, plugin, or system]
