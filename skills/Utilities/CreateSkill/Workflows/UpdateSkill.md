...
```
~/.config/openpai/PAI/SkillSystem.md
```
...
```bash
~/.config/openpai/skills/[SkillName]/SKILL.md
```
...
```bash
touch ~/.config/openpai/skills/[SkillName]/Tools/ToolName.ts
touch ~/.config/openpai/skills/[SkillName]/Tools/ToolName.help.md
```
