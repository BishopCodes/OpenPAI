...
1. Read the skill system documentation: `~/.config/openpai/PAI/SkillSystem.md`
2. Read the canonical example: `~/.config/openpai/skills/Research/SKILL.md`
...
```bash
mkdir -p ~/.config/openpai/skills/[SkillName]/Workflows
mkdir -p ~/.config/openpai/skills/[SkillName]/Tools
```

**Example:**
```bash
mkdir -p ~/.config/openpai/skills/YourSkill/Workflows
mkdir -p ~/.config/openpai/skills/YourSkill/Tools
```
...
```bash
touch ~/.config/openpai/skills/[SkillName]/Workflows/[WorkflowName].md
```
...
**Reference:** `~/.config/openpai/PAI/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)

**Examples (TitleCase):**
```bash
touch ~/.config/openpai/skills/YourSkill/Workflows/UpdateDaemonInfo.md
touch ~/.config/openpai/skills/YourSkill/Workflows/UpdatePublicRepo.md
touch ~/.config/openpai/skills/YourSkill/Workflows/Create.md
touch ~/.config/openpai/skills/YourSkill/Workflows/Publish.md
```
...
Run this check:
```bash
ls ~/.config/openpai/skills/[SkillName]/
ls ~/.config/openpai/skills/[SkillName]/Workflows/
ls ~/.config/openpai/skills/[SkillName]/Tools/
```
