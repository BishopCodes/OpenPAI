...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `~/.config/openpai/PAI/SkillSystem.md`

**Canonical example to follow:** `~/.config/openpai/skills/Research/SKILL.md`
...
**See:** `~/.config/openpai/PAI/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `~/.config/openpai/PAI/SkillSystem.md` (Dynamic Loading Pattern section)
