...
```bash
bun ~/.config/openpai/skills/Utilities/AudioEditor/Tools/Pipeline.ts \
  "<audio-file-path>" \
...
```bash
# Transcription only
bun ~/.config/openpai/skills/Utilities/AudioEditor/Tools/Transcribe.ts <file>

# Analysis only (requires transcript)
bun ~/.config/openpai/skills/Utilities/AudioEditor/Tools/Analyze.ts <transcript.json>

# Edit only (requires audio + edits)
bun ~/.config/openpai/skills/Utilities/AudioEditor/Tools/Edit.ts <file> <edits.json>

# Polish only (requires CLEANVOICE_API_KEY)
bun ~/.config/openpai/skills/Utilities/AudioEditor/Tools/Polish.ts <file>
```
