...
```bash
bun run ~/.config/openpai/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
```bash
bun run ~/.config/openpai/skills/Utilities/Prompting/Tools/ValidateTemplate.ts \
...
- `~/.config/openpai/PAI/Prompting.md` (Templating section)
- `~/.config/openpai/History/research/2025-12/2025-12-09-templating-system-research.md`
- `~/.config/openpai/History/learnings/2025-12/2025-12-09-021700_LEARNING_complete-templating-system-and-evals-integration.md`
- `~/.config/openpai/skills/Utilities/Evals/SKILL.md`
