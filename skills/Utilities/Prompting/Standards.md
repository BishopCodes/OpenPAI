...
**Location:** `~/.config/openpai/skills/Utilities/Fabric/Patterns/`
...
```bash
~/.config/openpai/skills/Utilities/Fabric/Tools/update-patterns.sh
```
...
All templates live in `~/.config/openpai/skills/Utilities/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ~/.config/openpai/skills/Utilities/Prompting/Tools/RenderTemplate.ts \
...
**Programmatic Usage:**
```typescript
import { renderTemplate } from '~/.config/openpai/skills/Utilities/Prompting/Tools/RenderTemplate.ts';
