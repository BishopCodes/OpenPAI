...
| `~/.config/openpai/agents/BrowserAgent.md` | AI-driven browser agent definition |
| `~/.config/openpai/agents/UIReviewer.md` | User story validation agent definition |

## Related

- [BrowserAgent](~/.config/openpai/agents/BrowserAgent.md)
- [UIReviewer](~/.config/openpai/agents/UIReviewer.md)
