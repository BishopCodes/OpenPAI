...
import { insertNewsletterContent } from '~/.config/openpai/skills/parser/db';
...
- For traditional PDF extraction (text-only), see `~/.config/openpai/skills/documents/pdf/SKILL.md`
- For PDF form filling, see `~/.config/openpai/skills/documents/pdf/forms.md`
- For parser integration, see `~/.config/openpai/skills/parser/SKILL.md`
- For newsletter database schema, see `~/.config/openpai/Context/databases/newsletter/schema.sql`
