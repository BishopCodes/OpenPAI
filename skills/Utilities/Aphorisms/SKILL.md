...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Aphorisms/`
...
**Location:** `~/.config/openpai/skills/aphorisms/Database/aphorisms.md`
...
**Database Location:**
`~/.config/openpai/skills/aphorisms/Database/aphorisms.md`
