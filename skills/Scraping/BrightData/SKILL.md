...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/BrightData/`
...
- `~/.config/openpai/PAI/SkillSystem.md` - Canonical structure guide
- `~/.config/openpai/PAI/CONSTITUTION.md` - Overall PAI philosophy
