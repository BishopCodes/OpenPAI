...
**Location:** `~/.config/openpai/skills/social/SKILL.md`
...
2. System runs: `bun ~/.config/openpai/filesystem-mcps/apify/get-latest-tweet.ts`
...
bun ~/.config/openpai/filesystem-mcps/apify/get-user-tweets.ts ThePrimeagen 10

# Analyze Paul Graham's recent thoughts
bun ~/.config/openpai/filesystem-mcps/apify/get-user-tweets.ts paulg 20

# Track Simon Willison's posts
bun ~/.config/openpai/filesystem-mcps/apify/get-user-tweets.ts simonw 15
```
...
bun ~/.config/openpai/filesystem-mcps/apify/get-latest-thread.ts
...
bun ~/.config/openpai/filesystem-mcps/apify/get-latest-tweet.ts
...
✅ Run from `~/.config/openpai/filesystem-mcps/apify/` directory or use full path
...
**For Users:**
- Quick reference: `~/.config/openpai/filesystem-mcps/SCRIPTS-REFERENCE.md`
- Social skill: `~/.config/openpai/skills/social/SKILL.md`

**For Developers:**
- Implementation: `~/.config/openpai/filesystem-mcps/apify/README.md`
- Standards: `~/.config/openpai/filesystem-mcps/STANDARDS.md`
- Parent guide: `~/.config/openpai/filesystem-mcps/README.md`
