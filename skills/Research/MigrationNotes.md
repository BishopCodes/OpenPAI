...
- **Source:** `~/.config/openpai/commands/perform-claude-research.md`
- **Destination:** `~/.config/openpai/skills/Research/Workflows/ClaudeResearch.md`
- **Size:** 3.6K
...
- **Source:** `~/.config/openpai/commands/perform-perplexity-research.md`
- **Destination:** `~/.config/openpai/skills/Research/Workflows/PerplexityResearch.md`
- **Size:** 8.1K
...
- **Source:** `~/.config/openpai/commands/perform-interview-research.md`
- **Destination:** `~/.config/openpai/skills/Research/Workflows/InterviewResearch.md`
- **Size:** 4.4K
...
- **Source:** `~/.config/openpai/commands/analyze-ai-trends.md`
- **Destination:** `~/.config/openpai/skills/Research/Workflows/AnalyzeAiTrends.md`
- **Size:** 3.0K
...
**Location:** `~/.config/openpai/skills/Research/Workflows/`
...
The original command files remain in `~/.config/openpai/commands/`:
