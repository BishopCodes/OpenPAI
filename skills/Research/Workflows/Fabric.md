...
**Patterns Location:** `~/.config/openpai/skills/Fabric/Patterns/`
...
Patterns are managed by the Fabric skill at `~/.config/openpai/skills/Fabric/`.
...
```bash
ls ~/.config/openpai/skills/Fabric/Patterns/
```
...
**Full Pattern List:** `ls ~/.config/openpai/skills/Fabric/Patterns/`
**Fabric Skill:** `~/.config/openpai/skills/Fabric/SKILL.md`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `~/.config/openpai/skills/Fabric/Patterns/official_pattern_template/`
