...
```
~/.config/openpai/MEMORY/RESEARCH/{YYYY-MM}/{YYYY-MM-DD}_{topic-slug}/
```

Read `~/.config/openpai/MEMORY/STATE/current-work.json` for the active work directory.
...
Templates live at `~/.config/openpai/skills/Research/Templates/{DomainName}.md`
