...
# Load: ~/.config/openpai/skills/Parser/Workflows/ExtractYoutube.md
```
...
```typescript
import { PAI_THEME } from '~/.config/openpai/skills/Remotion/theme'
...
- Load: `~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
- Apply: Charcoal aesthetic, purple accents, organic animations
- Reference: `~/.config/openpai/skills/Remotion/theme.ts`
