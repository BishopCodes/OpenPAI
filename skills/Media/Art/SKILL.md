...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load from:** `~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
...
bun run ~/.config/openpai/skills/Media/Art/Tools/Generate.ts \
