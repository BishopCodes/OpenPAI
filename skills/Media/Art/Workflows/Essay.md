...
```bash
Read ~/.config/openpai/skills/Media/Art/SKILL.md
```
...
bun run ~/.config/openpai/skills/art/Tools/Generate.ts \
...
3. EMOTION → Match to register in ~/.config/openpai/PAI/aesthetic.md
