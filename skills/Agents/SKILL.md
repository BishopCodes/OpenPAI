...
```
~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/Agents/
...
Each voice can have prosody settings that control how it sounds. These are passed to Kokoro API.
...
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --task "Review security"
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --traits "security,skeptical,thorough"

# Persistent custom agents
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --task "Security review" --save
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --list-saved
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --load "security-expert-skeptical-thorough"
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --delete "security-expert-skeptical-thorough"

# Other options
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --list
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts --output json
```
