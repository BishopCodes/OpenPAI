...
Old YAML system backed up to: `~/.config/openpai/History/Backups/2025-12-18-AgentProfiles/`
...
bun run ~/.config/openpai/skills/Agents/Tools/LoadAgentContext.ts
# Output: Architect, Artist, Engineer, Designer, QATester

# View specific context
bun run ~/.config/openpai/skills/Agents/Tools/LoadAgentContext.ts Architect

# Generate enriched prompt
bun run ~/.config/openpai/skills/Agents/Tools/LoadAgentContext.ts Engineer "Implement TDD workflow"
```
