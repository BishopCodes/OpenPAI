...
bun run ~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts \
...
- ComposeAgent tool: `~/.config/openpai/skills/Agents/Tools/ComposeAgent.ts`
- Voice mappings: `~/.config/openpai/skills/Agents/AgentPersonalities.md`
