...
bun run ~/.config/openpai/skills/Agents/Tools/LoadAgentContext.ts Architect "Design new skill system"
```
...
1. Create `[AgentType]Context.md` in `~/.config/openpai/skills/Agents/`
