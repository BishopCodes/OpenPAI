...
```
~/.config/openpai/MEMORY/WORK/$(jq -r '.work_dir' ~/.config/openpai/MEMORY/STATE/current-work.json)/YYYY-MM-DD-HHMMSS_due-diligence-[company]/
  phase1-domains.md
  phase2-technical.md
  phase3-research.md
  phase4-vetting.md
...
~/.config/openpai/History/research/YYYY-MM/[company]-due-diligence/
