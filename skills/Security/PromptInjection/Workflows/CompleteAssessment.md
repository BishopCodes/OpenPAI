...
**Save to:**
```
~/.config/openpai/History/research/YYYY-MM-DD_[client]-recon/
...
```
~/.config/openpai/History/research/YYYY-MM-DD_[client]-direct-injection/
├── findings.md
...
**Document findings in:**
```
~/.config/openpai/History/research/YYYY-MM-DD_[client]-indirect-injection/
├── findings.md
├── poisoned-documents/
├── test-web-pages/
...
```
~/.config/openpai/History/research/YYYY-MM-DD_[client]-multistage/
...
**Document in:**
```
~/.config/openpai/History/research/YYYY-MM-DD_[client]-defenses/
...
**Deliverables:**
```
~/.config/openpai/History/research/YYYY-MM-DD_[client]-final-report/
