...
export const CONFIG = {
  ...
  // Local paths
  paths: {
    root: '~/.config/openpai/skills/hacking/bug-bounties',
    state: '~/.config/openpai/skills/hacking/bug-bounties/state.json',
    cache: '~/.config/openpai/skills/hacking/bug-bounties/cache',
    logs: '~/.config/openpai/skills/hacking/bug-bounties/logs',
  },
