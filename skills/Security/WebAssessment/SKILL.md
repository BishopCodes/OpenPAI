...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/WebAssessment/`
...
bun ~/.config/openpai/skills/Security/Recon/Tools/CorporateStructure.ts target.com

# Subdomain enumeration
bun ~/.config/openpai/skills/Security/Recon/Tools/SubdomainEnum.ts target.com

# Endpoint discovery from JavaScript
bun ~/.config/openpai/skills/Security/Recon/Tools/EndpointDiscovery.ts https://target.com

# Port scanning
bun ~/.config/openpai/skills/Security/Recon/Tools/PortScan.ts target.com

# Path discovery
bun ~/.config/openpai/skills/Security/Recon/Tools/PathDiscovery.ts https://target.com
```
