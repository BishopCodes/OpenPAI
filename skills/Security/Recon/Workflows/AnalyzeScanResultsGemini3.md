...
SCAN_FILE=~/.config/openpai/MEMORY/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_nmap-scan.txt

# Or masscan results
MASSCAN_FILE=~/.config/openpai/MEMORY/WORK/${WORK_DIR}/$(date +%Y-%m-%d)_masscan.json

# Or combined multi-tool archive from history
SCAN_DIR=~/.config/openpai/History/security/scans/2025-11-target-recon/
```
...
// Usage: bun run tools/batch-scan-analysis.ts ~/.config/openpai/MEMORY/WORK/{current_work}/target-scans/
```
