...
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts search "crypto"
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts search "finance"
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts update

# Export as JSON
bun ~/.config/openpai/skills/Security/Recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `~/.config/openpai/skills/Security/Recon/Data/BountyPrograms.json`
