...
`~/.config/openpai/PAI/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
bun run ~/.config/openpai/skills/Security/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run ~/.config/openpai/skills/Security/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run ~/.config/openpai/skills/Security/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
