...
- World models must exist at `~/.config/openpai/MEMORY/RESEARCH/WorldModels/`
...
```
Check ~/.config/openpai/MEMORY/RESEARCH/WorldModels/ for all 11 model files.
...
Read all 11 model files from `~/.config/openpai/MEMORY/RESEARCH/WorldModels/`.
