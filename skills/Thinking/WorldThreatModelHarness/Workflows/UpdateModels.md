...
- Model template at `~/.config/openpai/skills/WorldThreatModelHarness/ModelTemplate.md`
...
```
Read ~/.config/openpai/MEMORY/RESEARCH/WorldModels/INDEX.md (if exists)
...
Save to: `~/.config/openpai/MEMORY/RESEARCH/WorldModels/{horizon}.md`

### Step 5: Update INDEX

Write/update `~/.config/openpai/MEMORY/RESEARCH/WorldModels/INDEX.md`:
