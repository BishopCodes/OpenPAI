...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `~/.config/openpai/PAI/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.config/openpai/PAI/USER/TELOS/` |
...
All files located in `~/.config/openpai/PAI/USER/TELOS/`:
...
```bash
# View specific file
read ~/.config/openpai/PAI/USER/TELOS/GOALS.md
read ~/.config/openpai/PAI/USER/TELOS/BELIEFS.md

# View recent updates
read ~/.config/openpai/PAI/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.config/openpai/PAI/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `~/.config/openpai/PAI/USER/TELOS/` (in the CORE USER directory)
