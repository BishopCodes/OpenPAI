...
cp -r ~/.config/openpai/skills/Telos/ReportTemplate/* {output_dir}/
...
```
~/.config/openpai/skills/Telos/ReportTemplate/
```
...
Edit files in `~/.config/openpai/skills/Telos/ReportTemplate/components/`

**To change color scheme:**
Edit CSS custom properties in `~/.config/openpai/skills/Telos/ReportTemplate/app/globals.css`
