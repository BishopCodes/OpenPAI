...
```bash
cp -r ~/.config/openpai/skills/telos/dashboard-template /path/to/your/project
...
- Searches `~/.config/openpai/skills/Telos/` for `.md` files
- Searches `~/.config/openpai/skills/Telos/data/` for `.csv` files
